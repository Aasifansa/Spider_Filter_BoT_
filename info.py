...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002215419345')
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1002292402556')
...
SECOND_SHORTLINK_API = environ.get('SECOND_SHORTLINK_API', 'e27949c396504dca50e6caed52b70917f00593c9')
IS_SHORTLINK = bool(environ.get('IS_SHORTLINK', False))
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '0').split()]
MAX_B_TN = environ.get("MAX_B_TN", "5")
MAX_BTN = is_enabled((environ.get('MAX_BTN', "True")), True)
PORT = environ.get("PORT", "8080")
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/xyxmovie_hubAv')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/xyzmovie_hub')
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/How_too_penlink/27')
IS_TUTORIAL = bool(environ.get('IS_TUTORIAL', True))
MSG_ALRT = environ.get('MSG_ALRT', 'Wʜᴀᴛ Aʀᴇ Yᴏᴜ Lᴏᴏᴋɪɴɢ Aᴛ ?')
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002228337057'))
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'haivbhhwlvw')
...
PREMIUM_LOGS = int(environ.get('PREMIUM_LOGS', '-1002408181598'))
